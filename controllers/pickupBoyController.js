...
const createPickupBoy = async (req, res) => {
  try {
    ...
    // Create a new pickup boy document
    ...
    // Save the pickup boy document to the database
...
const getPickupBoyById = async (req, res) => {
  try {
    ...
    // Retrieve pickup boy document by pickup_id from the database
...
const updatePickupBoyById = async (req, res) => {
  try {
    ...
    // Find the existing pickup boy by pickup_id
    ...
    // Save the updated pickup boy to the database
...
const deletePickupBoyById = async (req, res) => {
  try {
    ...
    // Find and delete the pickup boy by pickup_id
